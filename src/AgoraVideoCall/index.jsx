...
class AgoraCanvas extends React.Component {
  ...
  join = async () => {
    const client = AgoraRTC.createClient({ mode: this.state.mode, codec: this.state.codec });
    try {
      const uid = isNaN(Number(this.props.uid)) ? null : Number(this.props.uid);
      await client.init(this.props.appId);
      ...
      await client.join(this.state.token, this.props.channel, uid);
      //console.log(state.token);
      //client.renewToken(this.props.appId);
      //console.log(state.token);
      ...
      console.log(`Joined channel ${this.props.channel}`, { variant: "info" });
  ...
  componentWillMount() {
    ...
    this.client.init($.appId, () => {
      ...
      //this.client.join($.appId, $.channel, $.uid, (uid) => {
        this.client.join(this.state.token, $.channel, $.uid, (uid) => {  
        console.log("User " + uid + " join channel successfully")
        console.log('At ' + new Date().toLocaleTimeString())
        this.client.renewToken($.appId);
        // create local stream
